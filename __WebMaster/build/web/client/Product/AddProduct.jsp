        ...
        <div class="wrapper">
            <div class="container main">
                <div class="row" style="height: 800px; width: 1200px">
                    <div class="col-md-6 side-image" style="background-image: url(/_WebMaster/assests/images/background/AddProduct.png)">
                    </div>
                           ...
                           <form action="/_WebMaster/control" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <label class="text-light text-opacity-75">
                                        <input type="radio" name="type" value="Java file" required> Java file
                                    </label>
                                    <label class="text-light text-opacity-75">
                                        <input type="radio" name="type" value="HTML file"> HTML file
                                    </label>
                                    <label class="text-light text-opacity-75">
                                        <input type="radio" name="type" value="JSP file"> JSP file
                                    </label>
                                </div>
                                <div class="">
                                ...
                                <div class="input-field">
                                    <input type="submit" class="submit" name="requestAction" value="Add Product">
                                </div> 
                           </form>
                        </div>  
                    </div>
