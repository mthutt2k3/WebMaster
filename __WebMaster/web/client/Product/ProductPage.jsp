                    ...
                    <div class="col-md-2" style="background-image: none">
                        <form action="/_WebMaster/control">
                            <button type="submit" style="border: none; padding: 0; background-color: transparent; outline: none;">
                                ...
                                <img class="img img-thumbnail" src="/_WebMaster/assests/images/product_thumnail/<%=x.getThumbnail()%>" alt="%=x.getProductName()%>">
                            </button>
                        </form>
                    </div>
                        ...
                        <div>
                            <div style="display: flex">
                                <form action="/_WebMaster/control">
                                    ...
                                    <input type="hidden" name="id" value="<%=x.getId()%>">
                                    <input type="submit" class="bg-transparent border-0 text-info h2" value="<%=x.getProductName()%>">
                                </form>
                                <div style="color: #f5c2c7; display: flex">
                                    <span class="text-info ms-2">
                                        <form action="/_WebMaster/control">
                                            ...
                                            <button type="submit" class="btn btn-light btn-sm p-1" style="background-color: #f5c2c7; border: none">
                                                <%=x.getType()%>
                                            </button>
                                        </form>
                                    </span>
                            ...
                            <div style="display: flex">
                                ...
                                <h5 class="ms-3" style="color: #FE7; display: flex">
                                    Rate: <%=x.getRate()%>/5*
                                </h5>
                            </div>
                            <%
                                if (pDAO.isPurchased(x.getId(), xUser.getEmail()) == 0) {
                            %>
                            ...
                            <div style="width: fit-content; height: fit-content">
                                <a  target="_blank"
                                    href="<%=x.getSource()%>"
                                    class="btn btn-outline-success d-flex align-items-center text-center">
